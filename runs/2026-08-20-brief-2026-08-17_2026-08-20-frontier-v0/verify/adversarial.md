...
eve 0.39.x ancestry independent re-fetch CONFIRMED: 0.39.0...0.39.1 ahead_by=24 contains f02bc3d3d3; 0.39.1...0.39.2 ahead_by=6 contains 2c01eab36d; 0.39.2...0.39.3 ahead_by=7 contains 542c380eec and 9a7964bbdd. All four SHAs are ancestors of eve@0.42.0 (behind_by=0). Self-mod gate at eve@0.39.3 packages/eve-self-modification/src/agent.ts is process.env.EVE_DEV === "1", not notes-only. npm latest 0.44.0 still 08-21 OUT. CONFIRMED. Pin eve@0.42.0.
