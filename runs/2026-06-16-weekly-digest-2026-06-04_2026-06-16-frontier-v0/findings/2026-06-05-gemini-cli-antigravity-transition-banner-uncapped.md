...
confidence: high
evidence:
  - url: https://github.com/google-gemini/gemini-cli/commit/f40498db6
    precision: release_note
---
# 2026-06-05-gemini-cli-antigravity-transition-banner-uncapped
...
release-channel status) lives in harvest/gemini-cli.md, with the curated signal in
signals/frontier-signals.yml.

## Receipt
- https://github.com/google-gemini/gemini-cli/commit/f40498db6
