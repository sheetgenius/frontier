...
channel: x.com
status: candidate
operator_consequence: Operators on older versions should upgrade immediately to avoid disk issues.
...
channel: x.com
status: candidate
operator_consequence: Gives operators better cost control.
