...
claim: Pi v0.80.0 released with breaking API changes moving global API to compat layer.
primary_url: https://x.com/PiChangelog/status/2069475435738480878
author: @PiChangelog
...
## Claim 2
claim_id: pi-extension-system-2026
source: pi-coding-agent
claim: Pi has a powerful native in-process extension API with deep lifecycle hooks.
